export function MoveList({
  ...
  moves: string[]
  /** Sizing classes; override to let the list flex inside a column. */
  className?: string
}) {
  ...
  return (
    <div
      className={`overflow-y-auto rounded-lg border border-neutral-200 bg-white p-3 text-sm tabular-nums dark:border-neutral-800 dark:bg-neutral-900 ${className}`}
    >
      {moves.length === 0 ? (
